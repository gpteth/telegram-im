...
func (s *Service) SendChatAction(ctx context.Context, token string, r *botapi.SendChatAction2) (result bool, err error) {
	...
	case botapi.Typing:
		i.Action = mtproto.MakeTLSendMessageTypingAction(&mtproto.SendMessageAction{
		}).To_SendMessageAction()
	case botapi.UploadingPhoto:
		i.Action = mtproto.MakeTLSendMessageUploadPhotoAction(&mtproto.SendMessageAction{
		}).To_SendMessageAction()
	case botapi.UploadingVideo:
		i.Action = mtproto.MakeTLSendMessageUploadVideoAction(&mtproto.SendMessageAction{
		}).To_SendMessageAction()
	case botapi.UploadingAudio:
		i.Action = mtproto.MakeTLSendMessageUploadAudioAction(&mtproto.SendMessageAction{
		}).To_SendMessageAction()
	case botapi.UploadingDocument:
		i.Action = mtproto.MakeTLSendMessageUploadDocumentAction(&mtproto.SendMessageAction{
		}).To_SendMessageAction()
	case botapi.UploadingVNote:
		i.Action = mtproto.MakeTLSendMessageUploadVideoAction(&mtproto.SendMessageAction{
		}).To_SendMessageAction()
	case botapi.RecordingVideo:
		i.Action = mtproto.MakeTLSendMessageRecordVideoAction(&mtproto.SendMessageAction{
		}).To_SendMessageAction()
	case botapi.RecordingAudio:
		i.Action = mtproto.MakeTLSendMessageRecordAudioAction(&mtproto.SendMessageAction{
		}).To_SendMessageAction()
	case botapi.FindingLocation:
		i.Action = mtproto.MakeTLSendMessageGeoLocationAction(&mtproto.SendMessageAction{
		}).To_SendMessageAction()
	default:
